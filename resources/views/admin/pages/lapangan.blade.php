    ...
    <table class="table">
        ...
        @foreach($lapangan as $item)
            <tr>
                ...
                <td>Rp {{ number_format($item['harga_per_jam']) }}</td>
                ...
                <td>
                    ...
                    <!-- DELETE -->
                    <a href="{{ route('lapangan.delete', $item['id_lapangan']) }}"
                ...
                <div class="modal-dialog">
                    <form method="POST" action="{{ route('lapangan.update', $item['id_lapangan']) }}">
                        ...
                        <div class="modal-content p-3">
                            ...
                            <input class="form-control mb-2" name="harga_per_jam" value="{{ $item['harga_per_jam'] }}">
